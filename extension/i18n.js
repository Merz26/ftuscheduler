export const dict = {
  en: {
    ...
    select_exam_sem: "Exam Semester",
    btn_refresh_week: "Fetch Schedule",
    btn_refresh_exams: "Fetch Exams",
    btn_sync_exams_cal: "📅 Sync to Calendar",
    loading_schedule: "Loading schedule from FTU...",
    loading_exams: "Loading exam schedule from FTU Portal...",
    loading_weeks: "Loading weeks list...",
    no_exams_found: "No exam schedule found for this semester.",
    ...
    student_id_placeholder: "e.g. 2412345678",
    password: "Password",
    ...
    diag_lichthi_btn: "Test /lichthi (Exam Schedule)",
  ...
  vi: {
    ...
    select_exam_sem: "Học kỳ lịch thi",
    btn_refresh_week: "Tải lịch",
    btn_refresh_exams: "Tải lịch thi",
    btn_sync_exams_cal: "📅 Đồng bộ Calendar",
    loading_schedule: "Đang tải lịch học từ FTU...",
    loading_exams: "Đang tải lịch thi từ Cổng Đào Tạo...",
    loading_weeks: "Đang tải danh sách tuần...",
    no_exams_found: "Chưa có lịch thi cho học kỳ này.",
    ...
    stat_updated: "Đã làm sạch",
    stat_skipped: "Bỏ qua",
    stat_clashes: "Trùng lịch",
    sync_stat_inserted: "Đã thêm mới",
    sync_stat_updated: "Đã làm sạch (Lớp cũ)",
    ...
    student_id_placeholder: "VD: 2412345678",
    password: "Mật khẩu",
    ...
    diag_lichthi_btn: "Kiểm tra /lichthi (Lịch thi)",
